...
run_test!(
    test_ex03_conditionals,
    "examples/03-conditionals.lisp",
    50_000
);
...
run_test!(
    test_ex07_pattern_matching,
    "examples/07-pattern-matching.lisp",
    100_000
);
run_test!(
    test_ex08_error_handling,
    "examples/08-error-handling.lisp",
    100_000
);
run_test!(
    test_ex09_stdlib_math,
    "examples/09-stdlib-math.lisp",
    200_000
);
run_test!(
    test_ex10_stdlib_string,
    "examples/10-stdlib-string.lisp",
    200_000
);
run_test!(
    test_ex11_stdlib_crypto,
    "examples/11-stdlib-crypto.lisp",
    50_000
);
...
run_test!(
    test_ex17_type_conversions,
    "examples/17-type-conversions.lisp",
    50_000
);
run_test!(test_ex18_gas, "examples/18-gas.lisp", 5_000_000);
run_test!(
    test_ex19_real_world,
    "examples/19-real-world.lisp",
    2_000_000
);
